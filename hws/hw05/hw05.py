class VendingMachine:
    ...
    def vend(self):
        if self.inventory == 0:
            ...
            sold_count = self.balance // self.price
            if sold_count > self.inventory:
                sold_count = self.inventory
                self.inventory = 0
            else:
                self.inventory -= sold_count
            change = self.balance - sold_count * self.price
            self.balance = 0
            if change != 0:
